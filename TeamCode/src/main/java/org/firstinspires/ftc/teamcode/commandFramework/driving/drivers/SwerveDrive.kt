...
import org.firstinspires.ftc.teamcode.commandFramework.driving.SwerveDriveConstants
import org.firstinspires.ftc.teamcode.commandFramework.driving.localizers.Localizer
import java.util.*

/**
 * This object controls the movement of a swerve drivetrain. It's pretty complicated, so it might
 ...
 *
 * If you want to have multiple Swerve Drives in the same project, you don't need to make another
...
@Suppress("unused")
@Config
class SwerveDrive(constants: SwerveDriveConstants,
                  localizer: () -> Localizer,
                  startPose: () -> Pose2d = { Pose2d() }
) : Driver(constants, localizer, startPose) {

    constructor(constants: SwerveDriveConstants, localizer: Localizer, startPose: () -> Pose2d):
    ...
    // swivel servos
    private lateinit var leftFrontSwivel: Servo
    private lateinit var leftBackSwivel: Servo
    private lateinit var rightBackSwivel: Servo
    private lateinit var rightFrontSwivel: Servo
    private lateinit var swivelServos: List<Servo>
    ...
    override fun initialize() {
        ...
        constants as SwerveDriveConstants
        ...
        leftFrontSwivel = hardwareMap.get(Servo::class.java, constants.LEFT_FRONT_SWIVEL_NAME)
        leftBackSwivel = hardwareMap.get(Servo::class.java, constants.LEFT_BACK_SWIVEL_NAME)
        rightBackSwivel = hardwareMap.get(Servo::class.java, constants.RIGHT_BACK_SWIVEL_NAME)
        rightFrontSwivel = hardwareMap.get(Servo::class.java, constants.RIGHT_FRONT_SWIVEL_NAME)
        ...
        // and sets the achieveableMaxRPMFraction for each motor to 1.0
        for (motor in motors) {
